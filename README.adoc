...
* `java24.home`: this property must be set to the location of a Java 24 JDK installation
...
|build-test-java24|Run tests for Java 24 when `java24.home` is set and JDK 25 or later is used.|<<mr-jar-testing>>
